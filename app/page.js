...
//   const [savedGraphs, setSavedGraphs] = useState({}); // Store graphs for each day
...
//   const handleAnalyze = () => {
//     if (allDaysSaved) {
//       router.push("/analysis"); // Redirect to analysis page only when enabled
//     }
//   };
...
//       [`day${currentDay}`]: [...activities],
//     });
//     localStorage.setItem("savedGraphs", JSON.stringify(savedGraphs)); // Persist data
//     if (currentDay < 7) {
//       setCurrentDay(currentDay + 1);
//       setActivities([]); // Clear activities for next day
//     } else {
